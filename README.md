...
The package depends on Numpy, Keras, Tensorflow, and ROS. ROS is used for visualization.

# Compile

Download the package to your workspace and compile to code with ```catkin_make```.
